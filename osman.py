...
''', unsafe_allow_html=True)
    ...
    if selected_file == "Nilai Std. 11 SMA (KM)":
        ...
        if uploaded_file is not None:
            ...
            # rata" EKO ke EKO tambahan dan mapel EKO awal
            ws['AZ{}'.format(
                r)] = "=IF($AM${}=0,$N${},$N${}-1)".format(r, r, r)
            ws['AZ{}'.format(s)] = "=STDEV(AZ2:AZ{})".format(q)
            ws['AZ{}'.format(t)] = "=MAX(AZ2:AZ{})".format(q)
            ws['AZ{}'.format(u)] = "=MIN(AZ2:AZ{})".format(q)
            # rata" SOS ke SOS tambahan dan mapel SOS awal
            ws['BA{}'.format(
                r)] = "=IF($AN${}=0,$O${},$O${}-1)".format(r, r, r)
            ws['BA{}'.format(s)] = "=STDEV(BA2:BA{})".format(q)
            ws['BA{}'.format(t)] = "=MAX(BA2:BA{})".format(q)
            ws['BA{}'.format(u)] = "=MIN(BA2:BA{})".format(q)
            # rata" GEO ke GEO tambahan dan mapel GEO awal
            ws['BB{}'.format(
                r)] = "=IF($AO${}=0,$P${},$P${}-1)".format(r, r, r)
            ws['BB{}'.format(s)] = "=STDEV(BB2:BB{})".format(q)
            ws['BB{}'.format(t)] = "=MAX(BB2:BB{})".format(q)
            ws['BB{}'.format(u)] = "=MIN(BB2:BB{})".format(q)
            # rata" ANT ke ANT tambahan dan mapel ANT awal
            ws['BC{}'.format(
                r)] = "=IF($AP${}=0,$Q${},$Q${}-1)".format(r, r, r)
            ws['BC{}'.format(s)] = "=STDEV(BC2:BC{})".format(q)
            ws['BC{}'.format(t)] = "=MAX(BC2:BC{})".format(q)
            ws['BC{}'.format(u)] = "=MIN(BC2:BC{})".format(q)
            # jml MAPEL
            ws['BD{}'.format(r)] = "=ROUND(AVERAGE(BD2:BD{}),2)".format(q)
            ws['BD{}'.format(t)] = "=MAX(BD2:BD{})".format(q)
            ws['BD{}'.format(u)] = "=MIN(BD2:BD{})".format(q)
            # MAX Z SCORE
            ws['BE{}'.format(r)] = "=MAX(BE2:BE{})".format(q)
            ws['BF{}'.format(r)] = "=MAX(BF2:BF{})".format(q)
            ws['BG{}'.format(r)] = "=MAX(BG2:BG{})".format(q)
            ...
            ws['BJ{}'.format(r)] = "=MAX(BJ2:BJ{})".format(q)
            ws['BK{}'.format(r)] = "=MAX(BK2:BK{})".format(q)
            ws['BL{}'.format(r)] = "=MAX(BL2:BK{})".format(q)
            ws['BM{}'.format(r)] = "=MAX(BM2:BK{})".format(q)
            # NILAI STANDAR MTK
            ws['BH{}'.format(r)] = "=MAX(BH2:BH{})".format(q)
            ws['BH{}'.format(s)] = "=MIN(BH2:BH{})".format(q)
            ws['BH{}'.format(t)] = "=ROUND(AVERAGE(BH2:BH{}),2)".format(q)
